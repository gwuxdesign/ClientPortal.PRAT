...
public static class ClientPortal_PRAT_Acceptance_NUnitAssemblyHooks
{
    [global::NUnit.Framework.OneTimeSetUp]
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static async Task AssemblyInitializeAsync()
    {
        var currentAssembly = typeof(ClientPortal_PRAT_Acceptance_NUnitAssemblyHooks).Assembly;
